...
// Completed video card - shows video inline in a white card
function CompletedVideoCard({ videoUrl, isDark }: { videoUrl: string; isDark: boolean }) {
  ...
  return (
    <View style={{ marginHorizontal: 12, marginVertical: 4 }}>
      <View style={{ backgroundColor: '#fff', borderRadius: 16, overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 }}>
        <VideoView
          player={player}
        ...
        <View style={{ padding: 10, alignItems: 'center' }}>
          <Text style={{ color: '#10b981', fontSize: 13, fontWeight: '500' }}>✅ 视频已生成完成</Text>
        </View>
      </View>
    </View>
  );
